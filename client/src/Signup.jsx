    ...
    <div className="signup-container">
      ...
      <div className="form-section">
        <div className="form-container">
          <h2 className="text-center mb-4 italic-text">Register your account</h2>
          <form onSubmit={handleSubmit} className="p-4 border rounded shadow">
            ...
            <p className="mt-3 text-center">Already have an account? <Link to="/login" className="text-success">Login</Link></p>
          </form>
        </div>
      </div>
      <ToastContainer />
